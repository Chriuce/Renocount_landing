...
const steps = [
  {
    number: '1',
    title: 'Manager sends task to AI assistant',
    description: 'Managers send tasks to our AI assistant, which then intelligently distributes them to workers via WhatsApp with all necessary details.',
    icon: (
  ...
  {
    number: '2',
    title: 'Workers chat with AI naturally',
    description: 'Workers interact with the AI assistant through natural conversation, sending photos, updates, or asking questions - just like chatting with a colleague.',
    icon: (
      <svg className="w-8 h-8" fill="none" stroke="currentColor" viewBox="0 0 24 24">
  ...
  {
    number: '3',
    title: 'AI organizes everything automatically',
    description: 'The AI assistant processes all interactions, organizing updates, photos, and progress into a clear dashboard for managers to track.',
    icon: (
      <svg className="w-8 h-8" fill="none" stroke="currentColor" viewBox="0 0 24 24">

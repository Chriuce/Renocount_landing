      ...
      <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center pb-24">
        ...
        >
          ...
          >
            ...
            <br />
            <span className="text-primary-600">No apps. Just WhatsApp.</span>
          </motion.h1>
          ...
          >
            Meet your AI-powered WhatsApp assistant that helps construction teams report tasks, hours, and photos – no logins, no training needed.
          </motion.p>
          ...
          >
            ...
            <a
              href="#how-it-works"
              className="inline-flex items-center px-8 py-4 text-lg font-semibold text-gray-700 bg-white border-2 border-gray-200 hover:border-gray-300 rounded-xl shadow-lg hover:shadow-xl transition-all duration-300 transform hover:-translate-y-1"
            >
              See how it works
            </a>
          </motion.div>
